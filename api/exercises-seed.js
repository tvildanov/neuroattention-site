...
const EXERCISES = [
  {
    ...
    short_description_ru: 'Буквы идут потоком. Нажмите «совпадение», если текущая буква такая же, как N шагов назад — тренировка рабочей памяти.',
  ...
  },
  {
    ...
    short_description_ru: 'Слово написано цветными буквами. Выбирайте цвет чернил, а не то, что написано словом — классический тест Струпа.',
  ...
  },
  {
    ...
    short_description_ru: 'В ряду из пяти стрелок смотрите только на центральную и скажите, куда она указывает. Боковые — помеха.',
  ...
  },
  {
    ...
    short_description_ru: 'Нажимайте на каждую цифру, кроме тройки. Когда появляется 3 — остановитесь. Проверка устойчивого внимания.',
  ...
  },
  {
    ...
    short_description_ru: 'Кубики вспыхивают по очереди. Запомните порядок и нажмите те же кубики в том же порядке — объём зрительно-пространственной памяти.',
  ...
  },
  {
    ...
    short_description_ru: 'Запомните цифры и введите их. На высоких уровнях — в обратном порядке. Классический digit span.',
  ...
  },
  {
    ...
    short_description_ru: 'Зелёный круг — кликните. Красный — не кликайте. Тренирует торможение импульса.',
  ...
  },
  {
    ...
    short_description_ru: 'Подсказка говорит, по какому правилу отвечать: цвет или форма. Правило меняется — нужно быстро переключаться.',
  ...
  },
  {
    ...
    short_description_ru: 'Соединяйте кружки по порядку: в A — числа, в B — число–буква–число. Чем быстрее и без ошибок — тем лучше.',
  ...
  },
  {
    ...
    short_description_ru: 'В быстром потоке букв запомните белую букву и заметьте, была ли после неё X. Вторую цель часто «моргают» — это и измеряется.',
